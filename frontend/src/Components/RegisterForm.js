    ...
    <div>
      ...
      <div className='container mt-5 pt-5'>
        <div className='col-lg-6 mx-auto'>
          <form className="py-4 px-4 bg-info-subtle" onSubmit={handleSubmit}>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-md-6">
                <div className="d-flex h-100">
                  <div className="form-check d-flex align-items-center me-2">
                    <input className="form-check-input" type="radio" name="gender" value="male" id="radio1" checked={formData.gender === 'male'} onChange={handleChange} />
                    <label className="form-check-label" htmlFor="radio1">
                      Male
                    </label>
                  </div>
                  <div className="form-check d-flex align-items-center me-2">
                    <input className="form-check-input" type="radio" name="gender" value="female" id="radio2" checked={formData.gender === 'female'} onChange={handleChange} />
              ...
              <button type="submit" className="btn btn-primary rounded-0 w-50 mt-3">Register</button>
            </div>
          </form>
        </div>
      </div>
